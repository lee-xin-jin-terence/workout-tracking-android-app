...
/**
 * Instrumented tests for the StoredWorkoutSession class, testing methods related
 * to the Parcelable interface
 * */
public class StoredWorkoutSessionInstrumentedTest
{
    /**
     * Test that the writeToParcel and static Creator methods (part of Parcelable interface)
     * are correctly creating flattening an instance of StoredWorkoutSession into a Parcel, and
     * re-creating it back into an instance of StoredWorkoutSession
     * */
    @Test
    public void writeToParcel_and_StaticCreator_ValidValues_NoException()
    {
        ...
        StoredWorkoutSession originalWorkoutSession = new StoredWorkoutSession();

        originalWorkoutSession.setWorkoutSessionId(RANDOM_WORKOUT_SESSION_ID);
        ...
        StoredWorkoutSession createdFromParcel =
                StoredWorkoutSession.CREATOR.createFromParcel(parcel);
